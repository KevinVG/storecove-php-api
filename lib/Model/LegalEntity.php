 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LegalEntity implements ModelInterface, ArrayAccess
{
    ...
    public function setPartyName($party_name)
    {
        if (!is_null($party_name) && (strlen($party_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $party_name when calling LegalEntity., must be smaller than or equal to 64.');
        }
        if (!is_null($party_name) && (strlen($party_name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $party_name when calling LegalEntity., must be bigger than or equal to 2.');
        }
    ...
    public function setLine1($line1)
    {
        if (!is_null($line1) && (strlen($line1) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling LegalEntity., must be smaller than or equal to 64.');
        }
        if (!is_null($line1) && (strlen($line1) < 2)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling LegalEntity., must be bigger than or equal to 2.');
        }
    ...
    public function setLine2($line2)
    {
        if (!is_null($line2) && (strlen($line2) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling LegalEntity., must be smaller than or equal to 64.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (strlen($city) > 64)) {
            throw new \InvalidArgumentException('invalid length for $city when calling LegalEntity., must be smaller than or equal to 64.');
        }
        if (!is_null($city) && (strlen($city) < 2)) {
            throw new \InvalidArgumentException('invalid length for $city when calling LegalEntity., must be bigger than or equal to 2.');
        }
    ...
    public function setZip($zip)
    {
        if (!is_null($zip) && (strlen($zip) > 32)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling LegalEntity., must be smaller than or equal to 32.');
        }
        if (!is_null($zip) && (strlen($zip) < 2)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling LegalEntity., must be bigger than or equal to 2.');
        }
    ...
    public function setCounty($county)
    {
        if (!is_null($county) && (strlen($county) > 64)) {
            throw new \InvalidArgumentException('invalid length for $county when calling LegalEntity., must be smaller than or equal to 64.');
        }
