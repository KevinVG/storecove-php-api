...
class PublicIdentifier implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((strlen($this->container['scheme']) < 3)) {
    ...
    public function setId($id)
    {
        ...
        if ((strlen($id) < 2)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PublicIdentifier., must be bigger than or equal to 2.');
        }
