...
class DeliveryLocation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Delivery_location';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (strlen($id) < 2)) {
            throw new \InvalidArgumentException('invalid length for $id when calling DeliveryLocation., must be bigger than or equal to 2.');
        }
     ...
     *
     * @param string $scheme_agency_id The schemeAgencyId of the location identifier (e.g. 'ZZZ')
     *
     * @return $this
     */
