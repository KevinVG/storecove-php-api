...
class LegalEntityCreate implements ModelInterface, ArrayAccess
{
    ...
    {
        if ((strlen($line1) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling LegalEntityCreate., must be smaller than or equal to 64.');
        }
        if ((strlen($line1) < 2)) {
    ...
    public function setLine2($line2)
    {
        if (!is_null($line2) && (strlen($line2) > 64)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling LegalEntityCreate., must be smaller than or equal to 64.');
        }
