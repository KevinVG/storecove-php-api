...
class LegalEntitiesApi
{
     ...
     *
     * @param  \Swagger\Client\Model\LegalEntityCreate $legal_entity LegalEntity to create (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\LegalEntity
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\LegalEntity, HTTP status code, HTTP response headers (array of strings)
     */
    public function createLegalEntityWithHttpInfo($legal_entity)
    {
        $returnType = '\Swagger\Client\Model\LegalEntity';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\LegalEntity',
     ...
     *
     * @param  int $id legal_entity id (required)
     * @param  \Swagger\Client\Model\LegalEntityUpdate $legal_entity LegalEntity updates (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\LegalEntity
